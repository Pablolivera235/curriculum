...
function registrarClick(serieId) {
    fetch('home.php?serie_id=' + encodeURIComponent(serieId), {
        method: 'GET',
        credentials: 'include'
    })
    ...
    <nav>
        <div>
            ...
            <div><img class="knoledge" onclick="location.href='../../pages/discover.php'" src="../../assets/Descubrir.png" alt="Descubrir" title="Descubrir"></div>
             ...
             <div id="div-fav"><img id="fav_ico" onclick="location.href='./favoritos.php'" src="../../assets/star.png" alt="Fav" title="Favs"></div>
    </nav>
